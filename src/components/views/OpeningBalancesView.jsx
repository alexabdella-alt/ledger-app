            ...
            return (
              <div style={{maxWidth:680}}>
                ...
                {["Assets","Liabilities","Equity"].map(cat => {
                  const accts = (BOOKABLE_ACCOUNTS||[]).filter(a=>a.category===cat && a.code!==OBE);
