              ...
              return (
                <div>
                  ...
                  <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:12, marginBottom:20 }}>
                    {[["Billed YTD", fmt(billedYTD), "var(--sc-success)"],["Open receivables", fmt(openAR), openAR>0?"var(--sc-warning)":"var(--sc-success)"],["Last invoice", lastDate, "var(--sc-text)"]].map(([k,val,col])=>(
                          ...
                          <div style={{ padding:"16px 20px", display:"flex", alignItems:"center", gap:14 }}>
                            ...
                            <div style={{ display:"flex", gap:10, alignItems:"center", flexShrink:0 }}>
                              ...
                              {openAR>0 && <div style={{ textAlign:"right" }}>
                                <div style={{ fontSize:11, color:"var(--sc-text-2)" }}>OPEN RECEIVABLES</div>
