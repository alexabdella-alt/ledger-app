  ...
  const cockpit = navSeat ? navSeat.isReviewerSeat : true;
            ...
            return (
              <div>
                ...
                {loadFailures?.contacts ? <LoadFailedNotice what="customers" table="contacts" /> : allCustomers.length===0 ? (
