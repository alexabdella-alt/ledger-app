  ...
  const cockpit = navSeat ? navSeat.isReviewerSeat : true;
            ...
            return (
              <div>
                ...
                {loadFailures?.contacts ? <LoadFailedNotice what="customers" table="contacts" /> : !companyDataLoaded ? <LoadingList what="your customers" /> : allCustomers.length===0 ? (
