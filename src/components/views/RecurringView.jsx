                        ...
                        {recurring.map((r,i)=>{
                          ...
                          return (
                            <tr key={r.id} style={{borderTop:"1px solid var(--sc-border)",background:isDue?"var(--sc-warning-soft)":i%2===0?"transparent":"var(--sc-bg)"}}>
                              ...
                              <td style={{padding:"12px 16px",fontFamily:"'DM Mono',monospace",fontSize:14,fontWeight:600,color:"var(--sc-error)"}}>{"$"+(r.amount||0).toLocaleString("en-US",{minimumFractionDigits:2})}</td>
