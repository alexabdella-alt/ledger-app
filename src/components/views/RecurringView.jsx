                          ...
                          return (
                            <tr key={r.id} style={{borderTop:"1px solid var(--sc-border)",background:isDue?"var(--sc-warning-soft)":i%2===0?"transparent":"var(--sc-bg)"}}>
                              <td style={{padding:"12px 16px"}}>
                                ...
                                {isDue && <span style={{fontSize:10,color:"var(--sc-warning)",marginLeft:6}}>Due today</span>}
                              </td>
                              ...
                              <td style={{padding:"12px 16px"}}>
                                <div style={{display:"flex",gap:6}}>
                                  ...
                                  <button onClick={()=>setRecurring(prev=>prev.map(x=>x.id===r.id?{...x,active:!x.active}:x))} style={{padding:"5px 10px",borderRadius:7,fontSize:11,background:"transparent",border:"1px solid var(--sc-border-2)",color:"var(--sc-text-2)",cursor:"pointer"}}>{r.active?"Pause":"Resume"}</button>
                                  <button onClick={()=>{setRecurring(prev=>prev.filter(x=>x.id!==r.id));logAudit("recurring_deleted",`Deleted: ${r.name}`);}} style={{padding:"5px 10px",borderRadius:7,fontSize:11,background:"transparent",border:"1px solid var(--sc-border-2)",color:"var(--sc-error)",cursor:"pointer"}}>×</button>
                                </div>
                              </td>
                            </tr>
                          );
