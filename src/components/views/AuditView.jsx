...
export default function AuditView() {
  ...
  const detailFor = (entry) => navSeat?.isReviewerSeat ? entry.detail : scrubOwnerActivity(entry.detail);
            const colorMap = {
            ...
            return (
              <div>
                ...
                {loadFailures?.audit_log ? <LoadFailedNotice what="activity history" table="audit_log" /> : auditLog.length===0 ? (
