                  ...
                  <div style={{ display:"flex", alignItems:"center", gap:14, marginBottom:20 }}>
                    ...
                    <div>
                      ...
                      <div style={{ display:"flex", gap:8, marginTop:6, alignItems:"center" }}>
                        ...
                        {v.fromContact && <span onClick={async ()=>{ const r = await setVendor1099(v, !v.is1099); if (r?.ok) setSelectedContact(s=>({...s,is1099:!v.is1099})); }} style={{ fontSize:11, color:"var(--sc-gold)", cursor:"pointer", border:"1px solid var(--sc-gold-soft)", borderRadius:20, padding:"3px 10px" }}>{v.is1099?"Unflag 1099":"Flag for 1099"}</span>}
                      </div>
                    </div>
                  </div>
                          ...
                          <div style={{ padding:"16px 20px", display:"flex", alignItems:"center", gap:14 }}>
                            ...
                            <div onClick={()=>setSelectedContact(v)} style={{ flex:1, minWidth:0, cursor:"pointer" }}>
                              <div style={{ display:"flex", alignItems:"center", gap:8, flexWrap:"wrap" }}>
                                ...
                                {v.fromContact && <span onClick={e=>{e.stopPropagation();setVendor1099(v, !v.is1099);}} style={{ fontSize:10, background:v.is1099?"var(--sc-warning-soft)":"var(--sc-border)", color:v.is1099?"var(--sc-warning)":"var(--sc-text-2)", borderRadius:20, padding:"2px 7px", cursor:"pointer", border:`1px solid ${v.is1099?"var(--sc-warning-soft)":"var(--sc-border-2)"}` }}>{v.is1099?"1099 ✓":"+ 1099"}</span>}
