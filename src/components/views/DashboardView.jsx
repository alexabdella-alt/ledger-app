  ...
  return (
            <div>
              ...
              {(depreciationDueInfo?.count > 0) && (
                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", gap:16, flexWrap:"wrap", background:"#FFFAEB", border:"1px solid #FEDF89", borderRadius:12, padding:"14px 18px", marginBottom:20 }}>
                  <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontSize:12, color:"#B54708", opacity:0.85 }}>Through {depreciationDueInfo.throughDate} · nothing is posted until you run it.</div>
                    </div>
                  </div>
                  <button onClick={()=>runDepreciationThrough && runDepreciationThrough(new Date().toISOString().slice(0,10))}
                    style={{ flexShrink:0, background:"#B54708", color:"#FFFFFF", border:"none", borderRadius:8, padding:"9px 18px", fontSize:13, fontWeight:600, cursor:"pointer" }}>
