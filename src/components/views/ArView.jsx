...
90+ day customers: ${[...new Set(aging.d90plus.items.map(i=>i.vendor))].join(", ")||"none"}` },
            ...
            return (
              <div>
                ...
                {arView==="inbox" && (
                  <div>
                    {!companyDataLoaded && arAll.length===0 ? <LoadingList what="your invoices" /> : arAll.length===0 ? (
                ...
                {arView==="collections" && (
                  <div>
                    ...
                    {!companyDataLoaded && collectionsQueue.length===0 ? <LoadingList what="your invoices" /> : collectionsQueue.length===0 ? (
