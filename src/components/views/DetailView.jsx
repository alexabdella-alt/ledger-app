...
export default function DetailView() {
  ...
  return (
            <div style={{ maxWidth:580 }}>
              <button onClick={()=>setView("invoices")} style={{ background:"none", border:"none", color:"#475467", cursor:"pointer", fontSize:14, marginBottom:24, padding:0 }}>← Back to invoices</button>
