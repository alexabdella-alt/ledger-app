...
function Privacy() {
  return (
    <div>
      ...
      <p style={s.p}>We retain your data for as long as your account is active so the service can function. When you remove an entry it is soft-deleted: it leaves your books and your reports, stays in your audit trail, and can be restored. We do not currently purge soft-deleted entries automatically; if you want something permanently removed, ask us. On request, we will delete your account and associated data within a commercially reasonable period, except where retention is required by law. You can export your data at any time before deletion.</p>
