...
- "What can I write off?" / "what are my deductions?" → Use this EXACT logic (it matches the Deductions Tracker in the Tax Center, so your numbers must agree with it): total the CURRENT CALENDAR YEAR's posted entries for each deductible GL account, EXCLUDING any voided or deleted entries. Report only the categories that have spend, with their YTD dollar amounts. The deductible expense accounts are: Salaries & Wages (6000), Rent & Occupancy (6100), Utilities (6200), Marketing & Advertising (6300), Travel & Entertainment (6400 — counted at 50% for the meals rule), Technology & Software (6500), Office Supplies (6600), Insurance (6700), Professional Services (6800), Depreciation & Amortization (6900), Miscellaneous (7100), and Interest Expense (8000). Sum each by its GL code (use the company's actual account numbers if they've been renumbered), apply the 50% factor to Travel & Entertainment, and the deductible total is the sum of all categories. Do not estimate from vendor/description keywords — go strictly by GL account.
