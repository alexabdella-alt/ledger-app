...
export const OWNER_JARGON_RE = /\bGAAP\b|\bASC\b|\bdebit(ed|s)?\b|\bcredit(ed|s)?\b(?!\s*card)|journal entr|\bledger\b|\bpayables?\b|\breceivables?\b|deferred revenue|balance sheet|capitaliz|depreciat|amortiz|\baccru|chart of accounts|\bgeneral ledger\b|\bGL\b|\bcontrol total|\breconcil|\btrial balance\b|\bconfidence\b|\bA\/[RP]\b/i;
