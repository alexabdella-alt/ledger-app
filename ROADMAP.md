...
- **Test suite:** 440 passing (`npm test`, 33 files). **Build:** clean (`npm run build`).
- **Migrations:** `000`–`044` (numbering non-contiguous; no new migrations through the C64–C75 passes — all code-only).
