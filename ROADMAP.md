...
- **Test suite:** 432 passing (`npm test`, 32 files). **Build:** clean (`npm run build`).
- **Migrations:** `000`–`044` (numbering non-contiguous; no new migrations through the C64–C73 passes — all code-only).
