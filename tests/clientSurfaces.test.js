...
describe("(2) client-visible copy assumes zero accounting knowledge", () => {
  ...
  const CLIENT_COMPONENTS = ["TransactionDetailPanel", "ClarificationFlow", "DocumentPreviewModal", "ChatRichOutput", "views/TrustPanel", "MailChannelSettings", "HeldMailLine"];
