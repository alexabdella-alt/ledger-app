...
describe("(2) client-visible copy assumes zero accounting knowledge", () => {
  ...
  const CLIENT_COMPONENTS = ["TransactionDetailPanel", "ClarificationFlow", "DocumentPreviewModal", "ChatRichOutput", "views/TrustPanel", "MailChannelSettings", "views/MonthlyReportsPanel", "ChatComposer", "ErrorBoundary", "CompanySwitcher"];   // C443/C444 — the monthly report panel sits inside Reports and said Receivables / Payables / Runway
