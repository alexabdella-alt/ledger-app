...
const LEDGER = [
  ...
  { id: 6, vendor: "Gas Co", amount: 800, date: `${Y}-01-10`, gl_code: "6200", gl_name: "Utilities", secondary_gl_code: "2000", type: "expense", status: "posted", payment_status: "unpaid", due_date: "2020-01-01" }, // overdue AP — a bill on terms carries A/P as its offset, as flatten emits (C532)
